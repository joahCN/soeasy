...
require(['jquery','angular','appModule', 'bootstrap','directive/fixCenter','service/networkService','service/loginService','service/storageService'], function($, angular, module, bootstrap, directive, service, loginService, storageService){
    $(function(){
        directive();
        service();
        loginService();
